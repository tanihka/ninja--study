        ...
        <>
            ...
            <footer >
                <div className="footer">
                    <div className="company"> <h2 className="footer-heading">About Us</h2>
                        <a href="/">Mission</a>
                        <a href="/">Careers</a>
                        <a href="/">Press</a>
                        <a href="/">Contact Us</a>
                    ...
                    <div className="company"> <h2 className="footer-heading">Help and Support</h2>
                        <a href="/">FAQs</a>
                        <a href="/">Blog</a>

                    </div>
                    <div className="company"> <h2 className="footer-heading">Privacy and terms</h2>
                ...
                <div className="bottom-footer">
                    ...
                    <div className="bottom-text">
                        <p>Mail Us: <a href="mailto:contact@tryninjastudy.com"> contact@tryninjastudy.com</a></p>
                        {/* <div className="social"> */}
                        <div className="social-icons">
                            <a href="https://www.linkedin.com/company/ninjastudy/?viewAsMember=true" target='_blanck'><i class="fa-brands fa-linkedin"></i></a>
                            <a href="https://twitter.com/tryninjastudy" target='_blanck'><i class="fa-brands fa-twitter"></i></a>
